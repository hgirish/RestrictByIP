// Based on Stackoverflow answer by sabbour
// http://stackoverflow.com/questions/473687/restrict-access-to-a-specific-controller-by-ip-address-in-asp-net-mvc-beta?lq=1
using System;
...
namespace RestrictByIP.Filters
{
    public class FilterIPAttribute : AuthorizeAttribute
    {
        ...
        public FilterIPAttribute(string allowedAdminSingleIPs,
            string configurationKeyAllowedMaskedIPs,
            string deniedSingleIPs,
            string deniedMaskedIPs)
        {

            ConfigurationKeyAllowedSingleIPs = allowedAdminSingleIPs;
            ConfigurationKeyAllowedMaskedIPs = configurationKeyAllowedMaskedIPs;
        ...
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            if (filterContext.HttpContext.Request.Url != null &&
                filterContext.HttpContext.Request.Url.PathAndQuery.ToLower().StartsWith("/error/"))
            {
                return;
            }
